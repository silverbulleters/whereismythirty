...
Контекст:
    ...
    И в общем модуле "РаботаСоСкидками" существует функция "ПолучитьСкидкуНоменклатуры"
	И в общем модуле "РаботаСоСкидками" функция "ПолучитьСкидкуНоменклатуры" является экспортной

Сценарий: Ввод данных по структуре номенклатурного справочника
    Допустим я создал группу "Товар 1 уровня без скидки" справочника "Номенклатура"
    И я создал группу "Товар 2 уровня без скидки" справочника "Номенклатура" с родителем "Товар 1 уровня без скидки"
    И я создал группу "Товар 3 уровня без скидки" справочника "Номенклатура" с родителем "Товар 2 уровня без скидки"
    И я создал группу "Товар 4 уровня со скидкой" справочника "Номенклатура" с родителем "Товар 3 уровня без скидки"
...
Сценарий: Скидка на номенклатуру низшего уровня определена
    ...
    Когда я вызываю функции "РаботаСоСкидками.ПолучитьСкидкуНоменклатуры" c элементом "Товар 5 уровня со скидкой"
...
Сценарий: Скидка на номенклатуру низшего уровня не определена
    ...
    Когда я вызываю функции "РаботаСоСкидками.ПолучитьСкидкуНоменклатуры" c элементом "Товар 5 уровня без скидки"
